...
import com.spring.hard.repository.CoureurRepository;
...
public class CoureurService {
    @Autowired
    private CoureurRepository repository;

    public Coureur saveOrUpdate(Coureur entity) {
        return repository.save(entity);
    }

    public Optional<Coureur> getById(Long id) {
        return repository.findById(id);
    }

    public Page<Coureur> getAll(int page, int size, String fieldTri) {
        Sort sort = null;
